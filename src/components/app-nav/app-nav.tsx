          ...
          <div class="flex items-center justify-between h-16">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <img class="h-8 w-8" src="../../assets/icon/bloons.png" alt="Logo" />
              </div>
                ...
                <div class="ml-3 relative">
                  <div>
                    <button class="max-w-xs bg-gray-800 rounded-full flex items-center text-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                      ...
                      <img class="h-8 w-8 rounded-full" src="../../assets/icon/shrek_pinch.jpg" alt="User Avatar" />
                    </button>
                  </div>
                  <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5">
                    <a href="/profile/francois" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Profile
                    </a>
        ...
        <div class="md:hidden" id="mobile-menu">
          ...
          <div class="pt-4 pb-3 border-t border-gray-700">
            <div class="flex items-center px-5">
              <div class="flex-shrink-0">
                <img class="h-10 w-10 rounded-full" src="../../assets/icon/shrek_pinch.jpg" alt="User Avatar" />
              </div>
              <div class="ml-3">
